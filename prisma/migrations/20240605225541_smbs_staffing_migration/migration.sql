...
ADD CONSTRAINT `ContactInformation_section_id_fkey` FOREIGN KEY (`section_id`) REFERENCES `Section` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ContactInformationContent`
ADD CONSTRAINT `ContactInformationContent_contact_information_id_fkey` FOREIGN KEY (`contact_information_id`) REFERENCES `ContactInformation` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ReferenceContent`
ADD CONSTRAINT `ReferenceContent_reference_id_fkey` FOREIGN KEY (`reference_id`) REFERENCES `SectionReference` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `SectionContent`
ADD CONSTRAINT `SectionContent_section_id_fkey` FOREIGN KEY (`section_id`) REFERENCES `Section` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `SectionReference`
ADD CONSTRAINT `SectionReference_section_id_fkey` FOREIGN KEY (`section_id`) REFERENCES `Section` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Section`
ADD CONSTRAINT `Section_page_id_fkey` FOREIGN KEY (`page_id`) REFERENCES `Page` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `ServiceContent`
ADD CONSTRAINT `ServiceContent_service_id_fkey` FOREIGN KEY (`service_id`) REFERENCES `Service` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Service`
ADD CONSTRAINT `Service_section_id_fkey` FOREIGN KEY (`section_id`) REFERENCES `Section` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `SubscriptionContent`
ADD CONSTRAINT `SubscriptionContent_subscription_id_fkey` FOREIGN KEY (`subscription_id`) REFERENCES `Subscription` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Subscription`
ADD CONSTRAINT `Subscription_section_id_fkey` FOREIGN KEY (`section_id`) REFERENCES `Section` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;